...
- **不符合常识或背景信息**，type 标记为“C”，意味着 text1 是 context 中的文本片段，且存在常识性的问题，或者和上下文透露的背景信息不符，并由 text2（不限于 context 中的内容）加以解释，如 `[“双手插在裤子口袋外”, “应该是双手插在裤子口袋里，而不是双手插在裤子口袋外”, “C”]`、`[“脖子旁戴着项圈”, “应该是脖子上戴着项圈，而不是脖子旁戴着项圈”, “C”]` 等。
