...
您在（以下简称“选手”）自愿报名参加 CCL2022 第二届中文空间语义理解评测（英文简称：SpaCE2022）（简称“比赛”）并点击报名页面的提交按钮之前，请务必仔细阅读并充分理解《第二届中文空间语义理解评测 SpaCE2022 参赛协议》（简称“本协议”）的内容，特别是以粗体标注的条款。

**如果选手不同意本协议的任何内容，或者无法准确理解某项条款，请不要点击报名页面的提交按钮**。举办方接受任何疑问咨询、建议，并将解释本协议内容，通讯方式已公布于本次比赛的官方网站（ https://2030nlp.github.io/SpaCE2022/ ）。
...
1. **数据集归大赛举办方所有。除本次比赛之外，选手及其他研究人员可以将本次评测的数据用于自然语言处理相关学术研究，使用时请在论文或其他相关资料中注明，如“本研究使用了北京大学组织的第二届中文空间语义理解评测提供的 SpaCE2022 数据集”，并在参考文献中引用举办方的评测报告论文。请关注举办方后续的论文发表情况。**
...
8. **请查阅并理解：第二届中文空间语义理解评测 SpaCE2022 数据集使用许可**（ https://github.com/2030NLP/SpaCE2022/blob/main/data/LICENSE.md ）。
